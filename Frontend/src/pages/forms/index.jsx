          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              <div className="inline-block bg-yellow-300 px-6 py-2 mb-4">
                <h1 className="text-xl md:text-2xl font-bold text-red-700" style={{ fontFamily: 'Georgia, serif' }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-800">Multiple Roles</h3>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-800">Simple Documentation</h3>
              ...
              <div className="border-2 border-gray-300 rounded-none p-6 bg-white shadow-lg">
                <h2 className="text-xl font-bold text-center text-gray-800 mb-6" style={{ fontFamily: 'Georgia, serif' }}>
